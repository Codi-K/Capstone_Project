<template>
  <div class="about">
    ...
    <div class="container my-5 d-flex justify-content-center p-5">
      <div class="container">
        <img
    ...
    <div class="my-4 py-5 text-bold"></div>
    <!-- About Grandline Vessels -->
    <div class="container">
      <h1>Our Story</h1>
    </div>
    <div class="container pb-2" style="width: 50%">
      <p>
        ...
        maritime services. Our diverse fleet, maintained to the highest safety
    ...
    <div class="d-flex justify-content-center gap-5 ">
      ...
      <div class="card border-dark" style="width: 18rem">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            Grandline Vessels' mission is to connect individuals, businesses,
            and adventurers with top-quality vessels while ensuring safety,
      ...
      <div class="card border-dark" style="width: 18rem">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            Grandline Vessels envisions global leadership in the maritime
            industry, setting standards for excellence, innovation,
            sustainability, and fulfilling maritime dreams.
          </p>
        </div>
      </div>
      <!-- Values -->
      <div class="card border-dark" style="width: 18rem">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            Grandline Vessels is guided by a set of core values that shape our
            company culture and define our approach to serving our customers and
